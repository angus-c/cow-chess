...
/***/ function(module, exports, __webpack_require__) {
	...
	var _game = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../data/game\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _game2 = _interopRequireDefault(_game);
	
	var _board = __webpack_require__(367);
	
	var _board2 = _interopRequireDefault(_board);
	
	var _info = __webpack_require__(388);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Piece2 = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Pawn = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _square = __webpack_require__(368);
	    ...
	    value: function render() {
	      ...
	      var renderCells = function renderCells(position) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'grid' },
	          [0, 1, 2, 3, 4, 5, 6, 7].map(function (rowId, i) {
	            return _react2.default.createElement(
	              'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Piece = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Info = function (_React$Component) {
	  ...
	  _createClass(Info, [{
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'span',
	                { className: 'header movePiece' },
	                'piece'
	              ),
	              _react2.default.createElement(
	                'span',
	                { className: 'header moveSquares' },
	                'from/to'
	              ),
	              _react2.default.createElement(
	                'span',
	                { className: 'header moveCapture' },
	                'captured'
	              ),
	              _react2.default.createElement(
	                'span',
	                { className: 'header moveTime' },
	                'time'
	              )
	            ),
	            moves.map(function (move, i) {
	              var piece = move.piece;
	              var fromTo = move.fromTo;
	              var capturedPiece = move.capturedPiece;
	              var time = move.time;
	              var myTextClass = move.myTextClass;
	              var theirTextClass = move.theirTextClass;
	
	              var pieceClass = 'movePiece ' + myTextClass;
	              var capturedPieceClass = 'moveCapture ' + theirTextClass;
	              return _react2.default.createElement(
	                'li',
	                { key: i },
	                _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'span',
	                  { className: 'moveSquares' },
	                  fromTo
	                ),
	                _react2.default.createElement(
	                  'span',
	                  { className: capturedPieceClass },
	                  capturedPiece
	                ),
	                _react2.default.createElement(
	                  'span',
	    ...
	    key: 'settingChanged',
	    value: function settingChanged(setting, e) {
	      // TODO really need an action here
	      _game2.default.set({
	        config: Object.assign({}, this.props.config, _defineProperty({}, setting, Number(e.target.value)))
	      });
	    }
	  }]);
	...
	Info.propTypes = {
	  moves: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object),
